...
landing_assert(substr_count($landing, '15% al comprador') === 3, 'landing keeps the buyer service charge at fifteen percent in every plan');
landing_assert(strpos($landing, 'El organizador recibe 2,5% adicional') !== false && strpos($landing, 'piso Tickex del 1%') !== false, 'landing explains the progressive organizer share and Tickex minimum');
}
