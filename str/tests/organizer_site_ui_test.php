...
site_ui_ok(strpos($landing,'Plataforma para productores')!==false&&strpos($landing,'Acceso de organizadores')!==false,'commercial landing explains the offer and provides a clear next action');
site_ui_ok(strpos($landing,'@media(max-width:580px)')!==false,'commercial landing is responsive');
