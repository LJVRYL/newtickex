...
$pdo->exec("CREATE TABLE IF NOT EXISTS tipos_entrada (id INTEGER PRIMARY KEY, evento_id INTEGER, nombre TEXT, tipo TEXT, precio REAL, cantidad_total INTEGER, cantidad_disponible INTEGER)");
