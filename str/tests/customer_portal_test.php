...
customer_assert(strpos($register, 'tx-login-shell tx-register-shell') !== false && strpos($register, 'max-width:480px') === false, 'registration uses the full-width public access layout');
customer_assert(strpos($layout, 'page-login page-registration') !== false, 'registration hides the internal navigation shell');
