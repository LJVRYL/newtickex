...
<main class="support-shell">
 ...
 <?php else:?>
 <section class="support-grid"><div class="card"><h2 style="margin-top:0">Guías rápidas</h2><p class="muted">Recorridos explicados para operar cada etapa con orden.</p><div class="support-guides"><a class="support-guide" href="guias.php?guia=evento"><strong>Crear y publicar un evento</strong><p>Del nombre y las fechas a la revisión del checkout.</p></a><a class="support-guide" href="guias.php?guia=ventas"><strong>Vender y emitir entradas</strong><p>Checkout, transferencias, montos libres y cortesías.</p></a><a class="support-guide" href="guias.php?guia=equipo"><strong>Organizar staff y puerta</strong><p>Roles, permisos, pruebas y contingencias.</p></a><a class="support-guide" href="guias.php?guia=comunicacion"><strong>Comunicar a tu audiencia</strong><p>Contactos, audiencias, pruebas y seguimiento.</p></a></div><p style="margin:14px 0 0"><a class="btn secondary" href="guias.php">Ver todas las guías</a></p></div>
