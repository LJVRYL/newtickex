...
<nav class="nav">
  <?php if ($isSuper): ?>
    ...
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Audiencias · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Plantillas · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Campanas · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Historial · Proximamente</span>
  ...
  <?php elseif (in_array($tg, array('admin_evento'), true)): ?>
    ...
    <div style="padding:8px 12px 2px;color:var(--muted);font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;">📣 Comunicacion</div>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">👥 Contactos · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Audiencias · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Plantillas · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Campanas · Proximamente</span>
    <span style="display:block;padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2);width:100%;font-weight:600;font-size:14px;color:var(--muted);opacity:.7;">Historial · Proximamente</span>
