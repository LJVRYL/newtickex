...
<main class="customer-portal">
  <section class="card customer-hero">
    ...
    <div class="customer-actions"><a class="btn" href="<?php echo e(tickex_route('customer_profile', array())); ?>">Mi perfil</a><?php if ($staffActive): ?><a class="btn secondary" href="<?php echo e(tickex_route('staff_home', array())); ?>">Panel de staff</a><?php endif; ?><?php if ($resellerActive): ?><a class="btn secondary" href="<?php echo e(tickex_route('reseller_home', array())); ?>">Panel de revendedor</a><?php endif; ?><a class="btn secondary" href="<?php echo e(tickex_route('logout', array())); ?>">Cerrar sesión</a></div>
