define(['knockout', 'dhm/sections/server/serverinfo/viewmodel', 'dhm/sections/server/services/viewmodel', 'whilecallback'], function(ko, serverinfoVM, servicesVM, WhileCallback) {
