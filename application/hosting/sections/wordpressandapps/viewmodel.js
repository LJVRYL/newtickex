define(['knockout', 'availableapp', 'webapp', 'wpstage', 'domain', 'email', 'translate', 'sort'], function(ko, AvailableApp, WebApp, WpStage, Domain, Email, Translate,Sort) {
    ...
    var wordpressandappsVM = function() {
        var self = this;
    ...
    wordpressandappsVM.prototype.init = function() {
        var self = this;
    ...
    wordpressandappsVM.prototype.cmpVersion = function(a, b) {
        var i, cmp, len;
        a = (a + '').split('.');
        b = (b + '').split('.');
    ...
    wordpressandappsVM.prototype.listAvailableApps = function() {
        var self = this;
        var theData = { "params": {
        }};
    ...
    wordpressandappsVM.prototype.changeStepFwd = function() {
        FerozoHosting.wordpressandappsVM().setStep("+");
    };

    wordpressandappsVM.prototype.changeStepBwd = function() {
        FerozoHosting.wordpressandappsVM().setStep("-");
    };

    wordpressandappsVM.prototype.resetStep = function() {
        FerozoHosting.wordpressandappsVM().step(1);
    };

    wordpressandappsVM.prototype.listWpStage = function() {
        var self = this;
        var theData = { "params": {
        }};
        self.setInprocess("+");
    ...
    wordpressandappsVM.prototype.list = function() {
        var self = this;
        var theData = { "params": {
        }};
        self.setInprocess("+");
    ...
    wordpressandappsVM.prototype.listDomains = function() {
        var self = this;
        var theData = { "params": {
    ...
    wordpressandappsVM.prototype.goToInstall = function() {
        var self = this;
        $('.modal').modal('hide');
        $('#app-list').trigger('click');
    };

    wordpressandappsVM.prototype.goToStage = function() {
        var self = this;
        $('#wp-stage').trigger('click');
    };

    wordpressandappsVM.prototype.switchInstalledTab = function(entity, event) {
        $('#app-installed').trigger('click');
    };

    wordpressandappsVM.prototype.switchInstalled = function(entity, event) {
        var self = this;
        self.switchInstalledTab();
        self.query(entity.nameKey());
    };

    wordpressandappsVM.prototype.openModalInstall = function(entity, event) {
        this.temp(entity);
        $('#modal-info').modal('hide');
        $('#installapp').modal('show');
    };

    wordpressandappsVM.prototype.openModalEditPass = function(entity, event) {
        this.tempEdit(entity);
        this.tempEdit().password('');
        $('#editpass').modal('show');
    };

    wordpressandappsVM.prototype.openModalEdit = function(entity, event) {
    ...
    wordpressandappsVM.prototype.openModalInfo = function(entity, event) {
        this.temp(entity);
        $('#modal-info').modal('show');
    };

    wordpressandappsVM.prototype.openModalNewStage = function() {
        $('#create-stage').modal('show');
    };
    
    wordpressandappsVM.prototype.stagePublishConfirm = function(entity, event) {
        var cloned = ko.mapping.fromJS(ko.toJS(entity));
        FerozoHosting.wordpressandappsVM().tempStaging(cloned);
        $("#staging-confirm-publish").modal('show');
    };

    wordpressandappsVM.prototype.renderChart = function(sizeorigin, availablespace) {
    ...
    wordpressandappsVM.prototype.redirectMc = function(entity, event) {
        var self = this;
        window.open('https://micuenta.donweb.com/xx-xx/servicios/sitios/'+self.serviceId()+'/configurar/wordpress-stage', '_blank');
    };

    wordpressandappsVM.prototype.redirectMcSpace = function(entity, event) {
        var self = this;
        window.open('https://micuenta.donweb.com/xx-xx/servicios/sitios/'+FerozoHosting.wordpressandappsVM().serviceId()+'/configurar/cambio-servicio', '_blank');
    };

    wordpressandappsVM.prototype.importWP = function(entity, event) {
        var self = this;
        window.location.href = '/#/tools/wordpressmigrator';
    };

    wordpressandappsVM.prototype.redirectDomain = function(subdomain) {
        var self = this;
        console.log(subdomain);
        window.open(subdomain, '_blank');
    };

    wordpressandappsVM.prototype.openModalWpRedirect = function(entity, event) {
        var self = this;
        self.tempWp(entity);
