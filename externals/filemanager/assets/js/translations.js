(function(angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function($translateProvider) {
        $translateProvider.translations('en', {
            ...
            drop_files_to_upload: "Drop your files anywhere in the window to upload them",
            drop_files_to_upload2: "You can also do it by dropping them directly into the files and folders list",
            files_uploading_to: " files uploading to",
            file_uploading_to: " uploading to",
            ...
            compress: "Compress",
            error: "Error",
            error_login: "An error occurred while trying to connect to the server",            
        ...
        $translateProvider.translations('pt', {
            ...
            drop_files_to_upload: "Solte seus arquivos em qualquer lugar da janela para carregá-los",
            drop_files_to_upload2: "Você também pode fazê-lo soltando-os diretamente na lista de arquivos e pastas",
            files_uploading_to: " archivos está subiéndose a",
            file_uploading_to: " está subiéndose a",
            ...
            compress: "Comprimir",
            error: "Erro",
            error_login: "Ocorreu um erro ao tentar se conectar ao servidor",
        ...
        $translateProvider.translations('es', {
            ...
            drop_files_to_upload: "Arrastre sus archivos a cualquier lugar de la ventana para subirlos",
            drop_files_to_upload2: "También puede hacerlo arrastrando directamente al listado de archivos y carpetas",
            files_uploading_to: " archivos están subiéndose a",
            file_uploading_to: " está subiéndose a",
            ...
            compress: "Comprimir",
            error: "Error",
            error_login: "Se produjo un error al intentar conectarse al servidor",
